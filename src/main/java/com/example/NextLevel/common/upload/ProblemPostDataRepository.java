...
@Repository
public class ProblemPostDataRepository implements ImageRepository {

    @Value("${problem.post.data.upload.path}")
    ...
    public String upload(MultipartFile file) {
        ...
        try {
            ...
            throw new IllegalArgumentException("[Error] 자료 업로드에 실패했습니다.");
        }
